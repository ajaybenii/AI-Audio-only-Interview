...
- If you receive "[SYSTEM] Candidate silent for 35 seconds - waiting for response": 
...
async def upload_recording(
    ...
    """
    Upload audio or screen recording.
    ...
    if recording_type == "screen":
        ...
        save_dir = AUDIO_COMBINED_DIR
        extension = ".webm"
    else: # Default "audio" -> User Mic Only
        save_dir = AUDIO_USER_DIR
        extension = ".webm"
    ...
    logger.info(f"Saved {recording_type} recording: {filename}")
